...
let latestReleaseResponse: unknown = null;
  ...
  it("auto-saves settings changes without save or cancel buttons", async () => {
    ...
    latestReleaseResponse = {
      ...
      assets: [
        {
          name: "ClipStash Next_99.0.0_x64_en-US.msi",
          browser_download_url:
            "https://github.com/LiKPO4/clipstash/releases/download/v99.0.0/ClipStash.Next_99.0.0_x64_en-US.msi",
        },
        {
          name: "ClipStash Next_99.0.0_x64-setup.exe",
          browser_download_url:
            "https://github.com/LiKPO4/clipstash/releases/download/v99.0.0/ClipStash.Next_99.0.0_x64-setup.exe",
        },
      ],
    };
    ...
    expect(invokeMock).toHaveBeenCalledWith("download_and_open_update_installer", {
      downloadUrl:
        "https://github.com/LiKPO4/clipstash/releases/download/v99.0.0/ClipStash.Next_99.0.0_x64-setup.exe",
      filename: "ClipStash Next_99.0.0_x64-setup.exe",
    });
