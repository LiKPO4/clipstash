...
let latestReleaseResponse: unknown = null;
  ...
  it("auto-saves settings changes without save or cancel buttons", async () => {
    ...
    latestReleaseResponse = {
      tag_name: "v2.1.9",
      html_url: "https://github.com/LiKPO4/clipstash/releases/tag/v2.1.9",
      body: "更新说明",
      assets: [
        {
          name: "ClipStash Next_2.1.9_x64_en-US.msi",
          browser_download_url:
            "https://github.com/LiKPO4/clipstash/releases/download/v2.1.9/ClipStash.Next_2.1.9_x64_en-US.msi",
        },
        {
          name: "ClipStash Next_2.1.9_x64-setup.exe",
          browser_download_url:
            "https://github.com/LiKPO4/clipstash/releases/download/v2.1.9/ClipStash.Next_2.1.9_x64-setup.exe",
        },
      ],
    };

    await user.click(within(dialog).getByRole("button", { name: "检查更新" }));
    expect(await within(dialog).findByText("发现新版本 2.1.9")).toBeTruthy();
    ...
    expect(invokeMock).toHaveBeenCalledWith("download_and_open_update_installer", {
      downloadUrl:
        "https://github.com/LiKPO4/clipstash/releases/download/v2.1.9/ClipStash.Next_2.1.9_x64-setup.exe",
      filename: "ClipStash Next_2.1.9_x64-setup.exe",
    });
