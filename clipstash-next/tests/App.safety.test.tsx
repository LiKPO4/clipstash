  ...
  it("auto-saves settings changes without save or cancel buttons", async () => {
    ...
    vi.stubGlobal(
      ...
      vi.fn().mockResolvedValue({
        ...
        json: async () => ({
          tag_name: "v2.0.4",
          html_url: "https://github.com/LiKPO4/clipstash/releases/tag/v2.0.4",
          body: "更新说明",
        }),
      }),
    );
    ...
    expect(await within(dialog).findByText("发现新版本 2.0.4")).toBeTruthy();
    await user.click(within(dialog).getByRole("button", { name: "打开 Release 页面" }));
    expect(openUrlMock).toHaveBeenCalledWith(
      "https://github.com/LiKPO4/clipstash/releases/tag/v2.0.4",
    );
  });
